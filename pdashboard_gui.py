...
#
# Created: Sat Oct 11 00:25:22 2014
...
class Ui_pdt(object):
    def setupUi(self, pdt):
        ...
        self.oauth_label = QtGui.QLabel(self.centralwidget)
        self.oauth_label.setGeometry(QtCore.QRect(10, 90, 46, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        font.setBold(True)
        self.oauth_label.setFont(font)
        self.oauth_label.setTextFormat(QtCore.Qt.AutoText)
        self.oauth_label.setScaledContents(True)
        self.oauth_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.chat_scroll = QtGui.QScrollBar(self.chat_container)
        self.chat_scroll.setGeometry(QtCore.QRect(240, 20, 20, 301))
        self.chat_scroll.setOrientation(QtCore.Qt.Vertical)
        self.chat_scroll.setObjectName("chat_scroll")
        self.chat_box = QtGui.QLineEdit(self.chat_container)
        self.chat_box.setGeometry(QtCore.QRect(10, 20, 231, 301))
        font = QtGui.QFont()
        font.setWeight(50)
        font.setBold(False)
        self.chat_box.setFont(font)
        self.chat_box.setAcceptDrops(False)
        self.chat_box.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        ...
        self.oauth = QtGui.QLineEdit(self.centralwidget)
        self.oauth.setGeometry(QtCore.QRect(70, 90, 251, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.oauth.setFont(font)
        self.oauth.setFrame(True)
        self.oauth.setEchoMode(QtGui.QLineEdit.PasswordEchoOnEdit)
...
"and Title", None, QtGui.QApplication.UnicodeUTF8))
        self.oauth_get.setText(QtGui.QApplication.translate("pdt", "Get Oauth Code", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.oauth_label.setText(QtGui.QApplication.translate("pdt", "Oauth:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.authorize_button.setText(QtGui.QApplication.translate("pdt", "Authorize", None, QtGui.QApplication.UnicodeUTF8))
